    ...
    <aside class="main-sidebar fixed offcanvas shadow" data-toggle='offcanvas'>
        <div class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li><a class="ajaxifyPage" href="artists.jsp">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="login.jsp"><i class="icon icon-document"></i>登陆</a>
                        </li>
                        <li>
                            <a href="person/profile.jsp"><i class="icon icon-document"></i>个人资料</a>
                        </li>
